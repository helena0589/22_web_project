	...
	<div id="wrapper">
		...
		<div id="signUp">
			<div class="signUpOne">
				...
				<p style="color: #CFCFCF;">※수정 불가능</p>
				<input type="text" class="signUpInputBox" name="memberid" placeholder="아이디 들어가있기" >
			</div>
			<div class="signUpOne">
			...
			<div id="profileBtns">
				<input type="submit" class="profileBtn" id="editProfile" value="회원정보 수정">
				<input type="submit" class="profileBtn" id="deleteProfile" value="회원정보 삭제">
			</div>
		</div>
	</div>
	<div class="push"></div>
...
#deleteProfile{
	border: solid 2px #C2372B;
	background-color: #C2372B;
} 
#deleteProfile:hover{
	color: #C2372B;
	background-color: #fff;
